...
public class GerenciamentoDeContatos {
    ...
    public void exibirContatos() {
        for (String nome : contatos.keySet()) {
            Contato value = contatos.get(nome);
            System.out.println("Nome: " + nome);
            System.out.println("Telefones: " + value.getTelefones());
            System.out.println("Emails: " + value.getEmails());
            System.out.println("-------------------------------");
        }
    }
    ...
    public void buscarContato(String nome) {
        ...
        if (this.contatos.containsKey(nome)) {
            ...
            System.out.println("Telefones: " + this.contatos.get(nome).getTelefones());
            System.out.println("Emails: " + this.contatos.get(nome).getEmails());
        }
    }
